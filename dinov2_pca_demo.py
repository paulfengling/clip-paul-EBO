...
def main(save_fg_mask=False, img_size=224, output_folder="outputs"):
    ...
    dinov2_vits14 = torch.hub.load('facebookresearch', "dinov2_vits14", source='local')
    ...
    images = [tf(Image.open(f"pca_ims/{i}.jpg")) for i in range(start_idx, end_idx + 1)]
